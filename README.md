...
2. **Demo:** In older versions (v1.2.0 and earlier), download the [`Example Route`](MotionView_Example.json), press `Cmd + O` in MotionView to open it, and press `Space` to watch a recorded run.
