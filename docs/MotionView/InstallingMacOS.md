...
## MacOS Gatekeeper Fix (only needed for once, `v1.2.0` and below only)
You can ignore this if you have MotionView `v1.3.0` or newer.
...
<p align="left">
    <img src="assets/Install/Mac/VerificationError.png" alt="Icon" width="315" />
</p>
